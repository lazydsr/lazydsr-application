...
<#include "public/publicstatic_css.ftl"/>
    ...
    <!-- jvectormap -->
    <link rel="stylesheet" href="${ctx}/static/plugins/jvectormap/css/jquery-jvectormap.css">
    <!-- Theme style -->
...
<div class="wrapper">
    <script>
        $.ajax({ url: "/manager", context: document.body, success: function(){
            alert("aaaa");
        }});
    </script>
    <!--头部-->
...
<!-- FastClick -->
<script src="${ctx}/static/plugins/fastclick/js/fastclick.js"></script>

<!-- Sparkline -->
<script src="${ctx}/static/plugins/jquery-sparkline/js/jquery.sparkline.min.js"></script>
<!-- jvectormap  -->
...
<!-- SlimScroll -->
<script src="${ctx}/static/plugins/jquery-slimscroll/js/jquery.slimscroll.min.js"></script>
<!-- ChartJS -->
<script src="${ctx}/static/plugins/chart/js/Chart.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="${ctx}/static/js/pages/dashboard2.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="${ctx}/static/js/init.js"></script>
</body>
</html>
